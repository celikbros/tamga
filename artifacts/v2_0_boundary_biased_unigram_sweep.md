...
| gold | `boundary_biased_lambda_0.25` | 50 | 5.8200 | 6.3400 | 2.6198 | 0.7572 | 1/50 |
| challenge | `boundary_biased_lambda_0.25` | 108 | 7.3704 | 8.1111 | 2.2872 | 0.7462 | 0/108 |
| gold | `boundary_biased_lambda_0.5` | 50 | 5.8200 | 6.3400 | 2.6198 | 0.7648 | 1/50 |
| challenge | `boundary_biased_lambda_0.5` | 108 | 7.3704 | 8.1111 | 2.2872 | 0.7502 | 0/108 |
| gold | `boundary_biased_lambda_1` | 50 | 5.8200 | 6.3400 | 2.6198 | 0.7686 | 1/50 |
| challenge | `boundary_biased_lambda_1` | 108 | 7.3704 | 8.1111 | 2.2872 | 0.7528 | 0/108 |
...
| `boundary_biased_lambda_0.25` | 34 | 25/25 | 0.0000 | 22.5000 |
| `boundary_biased_lambda_0.5` | 34 | 25/25 | 0.0000 | 22.5000 |
| `boundary_biased_lambda_1` | 34 | 25/25 | 0.0000 | 22.5000 |
...
| Category | `finite_protected_sp64_numeric_sp_floor` | `boundary_biased_lambda_0` | `boundary_biased_lambda_0.25` | `boundary_biased_lambda_0.5` | `boundary_biased_lambda_1` | `boundary_biased_lambda_2` | `boundary_biased_lambda_4` | `boundary_biased_lambda_8` |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| ambiguity | 0.7835 | 0.8125 | 0.8125 | 0.8333 | 0.8542 | 0.8542 | 0.8542 | 0.8800 |
| code_mixed | 0.5906 | 0.6301 | 0.6438 | 0.6438 | 0.6438 | 0.6438 | 0.6438 | 0.7097 |
| informal | 0.7416 | 0.7586 | 0.7586 | 0.7586 | 0.7586 | 0.7586 | 0.7727 | 0.7865 |
| negative_word | 0.8269 | 0.8269 | 0.8269 | 0.8269 | 0.8269 | 0.8269 | 0.8269 | 0.8440 |
| numbers_dates | 0.7963 | 0.8411 | 0.8411 | 0.8411 | 0.8411 | 0.8411 | 0.8411 | 0.9027 |
| proper_name | 0.7059 | 0.7105 | 0.7105 | 0.7105 | 0.7105 | 0.7237 | 0.7403 | 0.8193 |
| punctuation | 0.6569 | 0.7460 | 0.7460 | 0.7460 | 0.7460 | 0.7460 | 0.7460 | 0.7656 |
| question | 0.7143 | 0.8522 | 0.8696 | 0.8696 | 0.8696 | 0.8696 | 0.8696 | 0.9032 |
| softening | 0.6615 | 0.6875 | 0.6875 | 0.7031 | 0.7031 | 0.7031 | 0.7132 | 0.7704 |
| suffix_chain | 0.6036 | 0.6310 | 0.6310 | 0.6310 | 0.6310 | 0.6706 | 0.7011 | 0.8469 |
| verb_future | 0.6774 | 0.6942 | 0.6942 | 0.6942 | 0.6942 | 0.6942 | 0.6942 | 0.7302 |
| verb_past | 0.6667 | 0.8212 | 0.8344 | 0.8477 | 0.8609 | 0.8816 | 0.9091 | 0.9182 |
