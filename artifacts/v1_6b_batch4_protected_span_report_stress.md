...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| custom_tr_morph | ok | 34 | 25/25 (1.0000) | 0 | 0.0000 | 7.2647 | 1.4277 |  |
| unicode_char | ok | 34 | 0/25 (0.0000) | 25 | 1.0000 | 28.4412 | 5.5896 |  |

## Category Summary

| Category | custom_tr_morph | unicode_char |
| --- | ---: | ---: |
| code_like | 2/2 (1.0000) | 0/2 (0.0000) |
| code_mixed | 1/1 (1.0000) | 0/1 (0.0000) |
| english_passthrough | 2/2 (1.0000) | 0/2 (0.0000) |
| numbers_dates | 4/4 (1.0000) | 0/4 (0.0000) |
| protected_file | 2/2 (1.0000) | 0/2 (0.0000) |
| protected_file_date | 2/2 (1.0000) | 0/2 (0.0000) |
| protected_url | 1/1 (1.0000) | 0/1 (0.0000) |
| technical_comparator | 2/2 (1.0000) | 0/2 (0.0000) |
| turkish_apostrophe | 1/1 (1.0000) | 0/1 (0.0000) |
| url_code_mixed | 3/3 (1.0000) | 0/3 (0.0000) |
| uzbek_apostrophe | 5/5 (1.0000) | 0/5 (0.0000) |
