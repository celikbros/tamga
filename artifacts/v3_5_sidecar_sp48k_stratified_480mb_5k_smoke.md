...
Sidecar JSONL: `artifacts/private/v3_5_sidecar_sp48k_stratified_480mb_5k.sidecar.jsonl`
Private failure samples: `artifacts/private/v3_5_sidecar_sp48k_stratified_480mb_5k.failures.jsonl`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `stratified_480mb` | 5000 | 4910147 | 933164 | 0.190048 | 17 | 0.000018 | 5000 | 0 | 32556 | 0 | 0.006715 | 1832 |
...
| conservative mask bytes | 180509 |
| extra mask bytes | 32970 |
| extra mask bytes/raw byte | 0.006715 |
| extra/protected byte | 0.223466 |
| edge-aligned span rate | 0.086098 |
| crossing span rate | 0.913902 |
