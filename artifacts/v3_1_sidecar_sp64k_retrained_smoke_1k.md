...
Sidecar JSONL: `artifacts/private/v3_1_sidecar_sp64k_retrained_smoke_1k.sidecar.jsonl`
Private failure samples: `artifacts/private/v3_1_sidecar_sp64k_retrained_smoke_1k.failures.jsonl`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `real_mix_60k_sample` | 1000 | 2184279 | 342946 | 0.157006 | 2 | 0.000006 | 1000 | 0 | 6726 | 0 | 0.003418 | 671 |
...
| conservative mask bytes | 33795 |
| extra mask bytes | 7466 |
| extra mask bytes/raw byte | 0.003418 |
| extra/protected byte | 0.283566 |
| edge-aligned span rate | 0.030776 |
| crossing span rate | 0.969224 |
| max extra bytes/span | 4 |
