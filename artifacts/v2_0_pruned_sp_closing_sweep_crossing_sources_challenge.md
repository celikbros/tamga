...
| `pruned_rate100` | 108 | 464 | 305 | 170 | 0.557377 | 140 | 0 |
| `pruned_rate090` | 108 | 464 | 305 | 155 | 0.508197 | 125 | 0 |
| `pruned_rate070_count50` | 108 | 464 | 305 | 153 | 0.501639 | 124 | 0 |
...
## Train-Side Attribution: `pruned_rate100`
...
## Score Attribution: `pruned_rate100`
...
## Train-Side Attribution: `pruned_rate090`

| Bucket | Piece types | Eval crossing occurrences | Crossed boundaries | Share of crossed boundaries |
| --- | ---: | ---: | ---: | ---: |
| train_rate=1.00 | 3 | 5 | 7 | 0.045161 |
| train_rate=0.70-0.99 | 25 | 42 | 46 | 0.296774 |
| train_rate=0.40-0.69 | 2 | 3 | 3 | 0.019355 |
| train_rate=0.20-0.39 | 1 | 2 | 2 | 0.012903 |
| train_rate=0.00-0.19 | 12 | 15 | 15 | 0.096774 |
| train_rate=0.00 | 1 | 1 | 1 | 0.006452 |
| train_count< 20 | 38 | 57 | 81 | 0.522581 |
| no_train_stats | 0 | 0 | 0 | 0.000000 |

## Score Attribution: `pruned_rate090`

| Bucket | Piece types | Eval crossing occurrences | Crossed boundaries | Share of crossed boundaries |
| --- | ---: | ---: | ---: | ---: |
| counted_score | 82 | 125 | 155 | 1.000000 |
| floor_score | 0 | 0 | 0 | 0.000000 |
| score_missing | 0 | 0 | 0 | 0.000000 |
...
| `▁verdik` | 2 | 1 | 16 | 9 | 0.562500 | -12.525843 |
| `▁Kitapları` | 2 | 1 | 18 | 16 | 0.888889 | -11.831203 |
| `ştırılmış` | 2 | 1 | 7 | 7 | 1.000000 | -13.356305 |

## Train-Side Attribution: `pruned_rate070_count50`

| Bucket | Piece types | Eval crossing occurrences | Crossed boundaries | Share of crossed boundaries |
| --- | ---: | ---: | ---: | ---: |
| train_rate=1.00 | 3 | 5 | 7 | 0.045752 |
| train_rate=0.70-0.99 | 24 | 42 | 46 | 0.300654 |
| train_rate=0.40-0.69 | 2 | 3 | 3 | 0.019608 |
| train_rate=0.20-0.39 | 1 | 2 | 2 | 0.013072 |
| train_rate=0.00-0.19 | 11 | 14 | 14 | 0.091503 |
| train_rate=0.00 | 1 | 1 | 1 | 0.006536 |
| train_count< 20 | 38 | 57 | 80 | 0.522876 |
| no_train_stats | 0 | 0 | 0 | 0.000000 |

## Score Attribution: `pruned_rate070_count50`

| Bucket | Piece types | Eval crossing occurrences | Crossed boundaries | Share of crossed boundaries |
| --- | ---: | ---: | ---: | ---: |
| counted_score | 80 | 124 | 153 | 1.000000 |
| floor_score | 0 | 0 | 0 | 0.000000 |
| score_missing | 0 | 0 | 0 | 0.000000 |
