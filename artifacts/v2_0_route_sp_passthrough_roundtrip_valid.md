...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| finite_protected_sp64_highcost_sp_routes | 1994 | 1994 | 0 | 0 | 1.000000 | 0.158366 | 2843294 | 2843294 |

## Failure Samples

### finite_protected_sp64_highcost_sp_routes

No failures.

## Private Samples

Private failure samples: `artifacts/private/v2_0_route_sp_passthrough_roundtrip_valid_failures.jsonl`
