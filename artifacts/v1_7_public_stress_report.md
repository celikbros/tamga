...
| non_turkish_latin | 3 | 3/3 (1.0000) | n/a | 5.67 |
...
Text: `El niño comió piñata en Bogotá.`

Tokens:

```json
["▁El","▁niño","▁comió","▁piñata","▁en","▁Bogotá","."]
```

Decoded: `El niño comió piñata en Bogotá.`
...
Decoded: `Die Straße ist groß.`

Roundtrip exact: `True`

### non_turkish_latin

Text: `L'amico va all'università oggi.`
...
Decoded: `L'amico va all'università oggi.`
